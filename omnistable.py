...
def generate():
    ...
    with open(ENV_PATH, "w") as f:
        ...
        f.write(f"OMNIAGENT_IMAGE=ghcr.io/nexuslbs/omniagent:latest\n")
        f.write(f"DASHBOARD_IMAGE=ghcr.io/nexuslbs/omni-dashboard:latest\n")
        f.write(f"TOOLBOX_IMAGE=ghcr.io/nexuslbs/omni-stack-toolbox:latest\n")
        f.write(f"\n")
    ...
    print(f"Images:")
    print(f"  omniagent:   ghcr.io/nexuslbs/omniagent:latest")
    print(f"  dashboard:   ghcr.io/nexuslbs/omni-dashboard:latest")
    print(f"  toolbox:     ghcr.io/nexuslbs/omni-stack-toolbox:latest")
    print()
